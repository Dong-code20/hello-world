			...
			<el-aside width="200px">
				...
				>
					...
					<el-submenu index="2"
						...
						<el-menu-item index="5">5班</el-menu-item>
						<el-menu-item index="6">6班</el-menu-item>
					</el-submenu>
					<el-submenu index="3">
						<template #title>
							<span>九年级</span>
						</template>
						<el-menu-item index="7">7班</el-menu-item>
						<el-menu-item index="8">8班</el-menu-item>
						<el-menu-item index="9">9班</el-menu-item>
					</el-submenu>
				</el-menu>
			</el-aside>
			<el-container>
				...
				>
					<el-container class="subHeader">
						...
						<el-button
							style="width: 100px; height: 30px; margin: 20px"
							>新增记录</el-button
						>
					</el-container>
				</el-header>
				...
				<el-footer
					height="30px"
					class="footer"
					>Vue框架搭建，ElementPlus提供组件支持</el-footer
				>
			</el-container>
		</el-container>
	</el-container>
